...
axis(2,at = temp,labels = rev(reportable_SNPs$fullname),las=2,cex.lab = 0.25,tick = FALSE,cex.axis=0.5,line = -1)
axis(4,at = temp,labels = paste("N=",rowSums(frequency_summary),sep=""),las=2,cex.lab = 0.25,tick = FALSE,cex.axis=0.5,line = -0.5)
