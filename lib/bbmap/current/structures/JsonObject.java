...
//	}
	...
	public StringBuilder toText(StringBuilder sb, int level){
	...
	private static void appendEntry(StringBuilder sb, String key, Object value, int level){
		appendKey(sb, key);
	...
	private static void appendValue(StringBuilder sb, Object value, int level){
		...
		if(c==null || value==null){
			...
			sb.append(String.format(decimalFormat, (Double)value));
		}else if(c==Float.class && decimals>=0){
			sb.append(String.format(decimalFormat, (Float)value));
	...
	private static void appendArray(StringBuilder sb, Object[] array, int level){
